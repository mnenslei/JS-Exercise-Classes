...
const corvette = new Car('Corvette', 20);
corvette.fill(15);
corvette.drive(500);
console.log('task 2: ', corvette.drive());
...
const mike = new Lambdasian({
  name: 'Mike', 
  age: 25, 
  location: 'NY'
});
console.log('task 3: ', mike);
...
const jake = new Student ({
  ...
  className: 'WD49', 
  favSubjects: ['closures', 'loops']
})
console.log('task 5: ', jake)
/*
  TASK 6
